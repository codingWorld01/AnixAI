        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact-us">
              <Button className="bg-gradient rounded-full text-white py-5 sm:px-8 sm:py-6 text-lg font-medium hover:opacity-90 w-full sm:w-auto">
                Contact Us
              </Button>
            </Link>
            <Link href="/work">
              <Button variant="outline" className="rounded-full border-white/20 bg-background/40 backdrop-blur-sm text-white py-5 sm:px-8 sm:py-6 text-lg font-medium hover:bg-background/60 w-full sm:w-auto">
                View Our Work
              </Button>
            </Link>
          </div>
