        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground text-base">
              Our team has deep expertise in building generative AI solutions
              that deliver measurable results for data-driven companies.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-16 h-1 bg-white/30 mb-4"></div>
            <p className="text-muted-foreground text-base">
              We’ve helped numerous clients achieve significant ROI through
              tailored AI strategies and implementations.
            </p>
          </div>
