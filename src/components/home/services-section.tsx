...
const services = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-10 h-10 text-markovate-blue" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service) => (
            <Link
              ...
              className="group"
            >
              <div className="p-8 rounded-lg border border-border/40 bg-card/60 backdrop-blur-sm h-full flex flex-col group-hover:border-markovate-blue/50 transition-colors duration-300">
                <div className="mb-6">
                  {service.icon}
                </div>
                <h3 className="text-xl font-semibold mb-3 group-hover:text-markovate-blue transition-colors">
                  {service.title}
                </h3>
                ...
                <div className="mt-auto">
                  <span className="text-markovate-blue font-medium inline-flex items-center group-hover:translate-x-2 transition-transform">
                    Learn more
