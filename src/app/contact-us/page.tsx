  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.status === 200) {
        // Redirect to the success page instead of setting a success message
        router.push("/success");
        // Optionally reset the form (though the user won't see this since they'll be redirected)
        setFormData({
          interest: "",
          aiJourneyStage: "",
          firstName: "",
        ...
        setStatus({ type: "error", message: response.data.error || "Failed to send the message. Please try again." });
      }
    } catch (error: any) {
      console.log(error);
      setStatus({ type: "error", message: error.response?.data?.error || "An error occurred. Please try again later." });
    } finally {
        ...
        <div className="container px-4 md:px-8">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Get in touch with our experts to discuss how anixai can help transform your business with innovative Generative AI solutions.
            </p>
          </div>
                ...
                <CardContent className="p-8">
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        id="interest"
                        className="w-full p-3 rounded-md bg-background border border-border/60 text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
                      ...
                      >
                        ...
                        <option value="build-poc">
                          I am interested to build a POC and need more information
                        </option>
                    ...
                    <div className="space-y-2">
                      <label htmlFor="aiJourneyStage" className="text-sm font-medium">
                        What stage are you in your AI journey?*
                      </label>
                      <select
                        id="aiJourneyStage"
                        className="w-full p-3 rounded-md bg-background border border-border/60 text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 max-w-full"
                      ...
                      >
                        ...
                        <option value="early-exploratory">
                          Early exploratory phase. Need an AI partner to guide us.
                        </option>
                        <option value="fair-understanding">
                          Fair understanding of goals. Need to start AI discovery phase.
                        </option>
                      </select>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <Card className="border-border/40 bg-card/60">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-anixai-blue">+1 (415) 555-1234</p>
                    </CardContent>
                  </Card>
                  <Card className="border-border/40 bg-card/60">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-anixai-blue">+44 20 1234 5678</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  <Card className="border-border/40 bg-card/60">
                    <CardContent className="p-6">
                      ...
                      <p className="text-anixai-blue font-medium">+1 (800) 555-9876</p>
                    </CardContent>
                  </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="border-border/40 bg-card/60">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    With years of experience in AI solutions, we deliver innovative and reliable results tailored to your needs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-border/40 bg-card/60">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    We understand your unique challenges and provide bespoke AI strategies to drive your business forward.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-border/40 bg-card/60">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our team is here to support you every step of the way, ensuring a seamless and successful partnership.
                  </p>
                </CardContent>
              </Card>
            </div>
